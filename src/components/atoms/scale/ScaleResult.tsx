...
import { Scale } from "assets/images";

export const ScaleResult = () => {
  return (
    <Box width="425px" bg="gray" p="20px">
    <Box bg="white" width="385px">
      <Box mb="50px" p="50px">
      ...
      <Box position="relative">
        ...
        <Box position="absolute" top="13%" left="31%">
              <FlexWrapper width="60px" flexDirection="column" justifyContent="center">
                <Typography color='primary'><span>-</span>31.5 kg</Typography>
              </FlexWrapper>
              <Box width="20px" bg="red" borderRadius="50%">.</Box>
          </Box>
